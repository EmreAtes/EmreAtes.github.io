...
\name{Emre Ate\c{s}}
\address{\href{https://emreates.github.io}{https://emreates.github.io}}
...
\item \textbf{Thesis title:} Automating Telemetry- and Trace-Based Analytics on
...
%\item B. Aksar, Y. Zhang, \textbf{E. Ates}, B. Schwaller, O. Aaziz, V.J. Leung,
%  J. Brandt, M. Egele, A.K. Coskun, ``Proctor: A Semi-Supervised Performance
%  Anomaly Diagnosis Framework for Production HPC Systems.'' in \textit{Intl.
%  Supercomputing Conf.} (ISC-HPC), 2021.

\item \textbf{E. Ates}, B. Aksar, V.J. Leung, A.K. Coskun ``Counterfactual
explanations for multivariate time series.'' in \textit{International
...
practice,'' in \textit{IEEE Trans. on Cloud Computing} (TCC), 2020.
